...
def main() -> int:
    ...
    # Direct Config API callers do not go through Molecule's command runner,
    # which normally creates the reporting action before the provisioner adds
    # its completion state. Molecule 25+ requires this explicit initialization.
    config.scenario.results.add_action_result("side_effect")
